                    ...
                    <div class="le les">
                    	<a href="<?php echo U('Home/Cart/cart');?>" >
                            ...
                            <span class="shopping-num">
                                <em><?php echo ($cart_total_price[anum]); ?></em>
                                <b></b>
                            </span>
                        </a>                       
                    </div>
...
<script src="/Public/js/layer/layer.js"></script><!-- 弹窗js 参考文档 http://layer.layui.com/--> 
	<div class="layout">
        ...
        <div class="layout pa-to-10">            
            <!--商品图片轮播-->            
            <link rel="stylesheet" href="/Template/pc/default/Static/css/gundong.css" type="text/css">
            ...
            <script type="text/javascript" src="/Template/pc/default/Static/js/fangd.js"></script>
            
            <div class="left-area">
              <div class="left-area-tb">
                <div class="jqzoom"> <img src="<?php echo ($goods["original_img"]); ?>" jqimg="<?php echo ($goods["original_img"]); ?>" id="bigImage" width="480px" height="480px" alt=""/> </div>
                <!-- 修改的部分-start -->
                <div class="rollBox"> <a href="javascript:;" onMouseDown="ISL_GoDown()" onMouseUp="ISL_StopDown()" onMouseOut="ISL_StopDown()" class="img1" hidefocus="true"></a>
                  <div class="Cont" id="ISL_Cont">
                    <div class="ScrCont">
                      <div id="List1"> 
                        <!-- 图片列表 begin -->
                        <!--<div class="pic tb-selected"><a target="_blank"><img src="images/55_55_bai.jpg" width="50" height="50" /></a></div>-->
                        <?php if(is_array($goods_images_list)): foreach($goods_images_list as $k=>$v): ?><div class="pic"> 
                            	<a href="javascript:void(0);">
                                	<img src="<?php echo ($v["image_url"]); ?>" width="50" height="50" onMouseMove="$('#bigImage').attr('src','<?php echo ($v["image_url"]); ?>');$('#bigImage').attr('jqimg','<?php echo ($v["image_url"]); ?>');" />
                                </a>
			...
			<script  type="text/javascript" src="/Template/pc/default/Static/js/gund.js"></script>            
            <!--商品图片轮播 end-->        
            ...
            <div class="right-area-num">
                ...
                <div class="right-area ma-to--1">
                    ...
                    <!--商品促销 start-->	
                    <?php if($goods['promoting'] == 1): ?><div class="bef_fo2" style="font-size:14px; background-color:#F60; color:#FFFFFF; line-height:30px; position:absolute; width:100%">
                            <p style="background-color:#f72862">
                              <span style="font-size:20px; padding:0px 16px 0px 26px; vertical-align:middle; ">抢购价￥<?php echo ($goods["promote_price"]); ?></span>
                                <img class="clock_w" src="/Template/pc/default/Static/images/lz.png"/><span id="surplus_text">278天 01时 58分 26秒</span> 后结束，请快购买
                             </p>
                        </div>
						<script>
                            // 倒计时
                            function GetRTime2(){
								...
								var text = GetRTime('<?php echo (date("Y/m/d H:i:s",$goods["promote_end_time"])); ?>');								
            ...
            <div class="comm-param">
				...
				<script>
                    ...
                    function ajaxConsult(consult_type,page){
                            $.ajax({
                                type : "GET",
                                url:"/index.php?m=Home&c=goods&a=ajaxConsult&goods_id=<?php echo ($goods['goods_id']); ?>&consult_type="+consult_type+"&p="+page,//+tab,
                                success: function(data){
