...
return array(
   ...
   // 'DATA_CACHE_TYPE' =>  'File', 
    ...
    'HTML_CACHE_ON'     =>    false, // 开启静态缓存  @by zhaozhiliang  false
    ...
    'HTML_CACHE_RULES'  =>     array(  // 定义静态缓存规则
        ...
        'Goods:ajaxConsult'=>array('{:module}_{:controller}_{:action}_{goods_id}_{consult_type}_{p}',TPSHOP_CACHE_TIME),  // 商品咨询页静态缓存 3秒钟                
